        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><%= proyecto.getFecha_limite() %></td>
                    <td><%= proyecto.getTipo_duracion() %></td>
                    <td><%= proyecto.getNombreCreador() %></td>
                    <td><%= proyecto.getDescripcion_corta() %></td>
                    <td class="actions">
                        <a class='bx bx-edit' href="actualizarestadoproyecto.jsp?idProyecto=<%= proyecto.getId_proyecto()%>">Editar</a>
                        <a class='bx bx-edit' href="verproyecto.jsp?idProyecto=<%= proyecto.getId_proyecto() %>">Ver</a>
